...
import { useEffect, useState, useMemo, Suspense } from "react" // Tambahkan Suspense
...
// --- 1. KOMPONEN KONTEN UTAMA (LOGIC ADA DI SINI) ---
...
// Ini yang mencegah error build "useSearchParams missing Suspense"
